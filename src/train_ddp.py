...
from utils import calculate_accuracy, get_device, save_checkpoint, setup_logging
...
def setup_distributed():
    ...
    print(
        f"Initializing distributed training: rank {rank}, world size {world_size}, local rank {local_rank}"
    )
...
def main():
    parser = argparse.ArgumentParser(
        description="Train Jester Gesture Recognition Model"
    )
    parser.add_argument(
    ...
    train_dataset = JesterDataset(
        ...
        annotation_file=os.path.join(
            data_config["root_dir"], "annotations", "train.csv"
        ),
